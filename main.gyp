{
  ...
  'variables': {
    'protoc':                   '<!(which protoc)',
    'common_pb_proto':      'src/proto/common.proto',
    'meta_data_pb_proto':   'src/proto/meta_data.proto',
    'db_config_pb_proto':   'src/proto/db_config.proto',
    'data_pb_proto':        'src/proto/data.proto',
    'common_pb_desc':       'src/common.pb.desc',
    'meta_data_pb_desc':    'src/meta_data.pb.desc',
    'db_config_pb_desc':    'src/db_config.pb.desc',
  ...
  'targets' : [
    ...
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--cpp_out=src/.', '-Isrc/proto/.', '<(common_pb_proto)', ],
        },
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--descriptor_set_out=<(common_pb_desc)', '--include_imports', '-Isrc/proto/.', '<(common_pb_proto)', ],
        },
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--cpp_out=src/.', '-Isrc/proto/.', '<(meta_data_pb_proto)', ],
        }
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--descriptor_set_out=<(meta_data_pb_desc)', '--include_imports', '-Isrc/proto/.', '<(meta_data_pb_proto)', ],
        },
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--cpp_out=src/.', '-Isrc/proto/.', '<(db_config_pb_proto)', ],
        }
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--descriptor_set_out=<(db_config_pb_desc)', '--include_imports', '-Isrc/proto/.', '<(db_config_pb_proto)', ],
        },
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--cpp_out=src/.', '-Isrc/proto/.', '<(data_pb_proto)', ],
        }
      ],
    },
    {
      ...
      'actions': [ {
          ...
          'action':        [ '<(protoc)', '--descriptor_set_out=<(data_pb_desc)', '--include_imports', '-Isrc/proto/.', '<(data_pb_proto)', ],
        },
      ],
    },
  ],
