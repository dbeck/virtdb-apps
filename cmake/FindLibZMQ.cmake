...
IF(ZMQ_LIBRARY_STATIC)
  ...
  MESSAGE(STATUS "  OK : ZMQ_LIBRARY_STATIC  = ${ZMQ_LIBRARY_STATIC}")
ELSE(ZMQ_LIBRARY_STATIC)
  MESSAGE(STATUS "! KO : Static library not found, trying dynamic libs") 
...
IF(ZMQ_INCLUDE)
  MESSAGE(STATUS "  OK : ZMQ_INCLUDE         = ${ZMQ_INCLUDE}")
ELSE(ZMQ_INCLUDE)
  MESSAGE(STATUS "! KO : 0MQ includes")
ENDIF(ZMQ_INCLUDE)

IF(ZMQ_LIBRARY)
  MESSAGE(STATUS "  OK : ZMQ_LIBRARY         = ${ZMQ_LIBRARY}")
ELSE(ZMQ_LIBRARY)
...
IF(ZMQ_FOUND)
  MESSAGE(STATUS "  OK : 0MQ found: Lib=${ZMQ_LIBRARY} Inc=${ZMQ_INCLUDE}")
ELSE(ZMQ_FOUND)
  MESSAGE(STATUS "! KO : 0MQ NOT found")
