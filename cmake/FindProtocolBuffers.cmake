...
IF(PB_LIBRARY_STATIC)
  ...
  MESSAGE(STATUS "  OK : PB_LIBRARY_STATIC  = ${PB_LIBRARY_STATIC}")
...
IF(PB_INCLUDE)
  MESSAGE(STATUS "  OK : PB_INCLUDE         = ${PB_INCLUDE}")
ELSE(PB_INCLUDE)
  MESSAGE(STATUS "! KO : protocol buffer includes")
ENDIF(PB_INCLUDE)

IF(PB_LIBRARY)
  MESSAGE(STATUS "  OK : PB_LIBRARY         = ${PB_LIBRARY}")
ELSE(PB_LIBRARY)
...
IF(PB_COMPILER_PATH)
  ...
  MESSAGE(STATUS "  OK : PB_COMPILER        = ${PB_COMPILER}")
